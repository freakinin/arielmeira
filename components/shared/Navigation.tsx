...
export default function Navigation() {
  ...
  const instagramUrl = '' // Add Instagram link here
        ...
        <div className="flex items-center justify-between h-20">
                  ...
                  {activeSection === item.id && (
                    <motion.div
                      ...
                      className={`absolute bottom-0 left-0 right-0 h-0.5 ${
                        isScrolled ? 'bg-evergreen-500' : 'bg-white'
                      }`}
                      initial={false}
          ...
          <button
            ...
            className={`md:hidden p-2 transition-colors ${
              isScrolled
                ? 'text-stone-700 hover:text-evergreen-700'
              ...
              <li>
                {instagramUrl ? (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full text-left px-4 py-3 rounded-lg transition-colors duration-300 text-stone-600 hover:bg-wheat-100 flex items-center gap-2"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
                  ...
                  <div className="w-full text-left px-4 py-3 rounded-lg text-stone-400 flex items-center gap-2">
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
                      viewBox="0 0 24 24"
